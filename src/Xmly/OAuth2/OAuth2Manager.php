...
final class OAuth2Manager
{
     ...
     */
    public function refreshAccessToken($device_id, $refresh_token, $redirect_uri, $grant_type = 'refresh_token')
    {
        $params = array(
            'client_id' => $this->auth->getAppKey(),
            'client_secret' => $this->auth->appSecret(),
     ...
     */
    public function getAccessTokenInfo($device_id, $access_token)
    {
        $params = array(
            'client_id' => $this->auth->getAppKey(),
            'client_secret' => $this->auth->appSecret(),
